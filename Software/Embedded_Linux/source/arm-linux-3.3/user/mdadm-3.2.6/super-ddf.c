...
/* Magic numbers */
#if 1
#define	DDF_HEADER_MAGIC	(0x11DE11DE)
#define	DDF_CONTROLLER_MAGIC	(0x111111AD)
#define	DDF_PHYS_RECORDS_MAGIC	(0x22222222)
#define	DDF_PHYS_DATA_MAGIC	(0x33333333)
#define	DDF_VIRT_RECORDS_MAGIC	(0xDDDDDDDD)
#define	DDF_VD_CONF_MAGIC	(0xEEEEEEEE)
#define	DDF_SPARE_ASSIGN_MAGIC	(0x55555555)
#define	DDF_VU_CONF_MAGIC	(0x88888888)
#define	DDF_VENDOR_LOG_MAGIC	(0xF0EEdB01)
#define	DDF_BBM_LOG_MAGIC	(0x0CB1ADAB)
#else
