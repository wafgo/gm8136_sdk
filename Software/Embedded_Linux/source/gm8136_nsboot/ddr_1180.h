#ifndef __DDR_1180_H__
#define __DDR_1180_H__
    ...
    unsigned int DDR_arg[][2] ={{0x00, 0x09009D02},{0x2C, 0x00000000},{0x68, 0x00000000},
                                {0x08, 0x00421A50},{0x30, 0x00000000},{0x6C, 0x00000022},
                                {0x0C, 0x00000090},{0x34, 0x06060606},{0x70, 0x00000003},
                                {0x10, 0x00005454},{0x38, 0x06060606},{0x74, 0x00000033},
                                {0x14, 0x2F0D0E0A},{0x3C, 0x00630012},{0x78, 0x00000011},
                                {0x18, 0x42851323},{0x40, 0x00000000},{0x7C, 0xFFFFFFFF},
                                {0x1C, 0x00002046},{0x48, 0x000000FF},{0xA0, 0x87878787},
    ...
    unsigned int DDR_arg[][2] ={{0x00, 0x09009D02},{0x2C, 0x00000000},{0x68, 0x00000000},
                                ...
                                {0x14, 0x200E0F0B},{0x3C, 0x00620012},{0x78, 0x00000000},
                                {0x18, 0x42851323},{0x40, 0x00000000},{0x7C, 0xFFFFFFFF},
                                {0x1C, 0x00002046},{0x48, 0x000000FF},{0xA0, 0x87878787},
                                {0x20, 0x00006F01},{0x4C, 0x00000000},{0xA4, 0x87878787},
