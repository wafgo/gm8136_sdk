#ifndef __DDR_800_H__
#define __DDR_800_H__
    ...
    unsigned int DDR_arg[][2] ={{0x00, 0x09009D02},{0x2C, 0x00000000},{0x68, 0x00000000},
                                ...
                                {0x14, 0x1F090A07},{0x3C, 0x00620011},{0x78, 0x00000000},
                                {0x18, 0x31551212},{0x40, 0x00000000},{0x7C, 0xFFFFFFFF},
                                {0x1C, 0x0000202F},{0x48, 0x000000FF},{0xA0, 0x87878787},
    ...
    unsigned int DDR_arg[][2] ={{0x00, 0x09009D02},{0x2C, 0x00000000},{0x68, 0x00000000}, 
                                {0x08, 0x00401420},{0x30, 0x00000000},{0x6C, 0x00000022}, 
                                {0x0C, 0x00000080},{0x34, 0x06060606},{0x70, 0x00000003}, 
                                {0x10, 0x00004343},{0x38, 0x06060606},{0x74, 0x00000022}, 
                                {0x14, 0x15090A07},{0x3C, 0x00620011},{0x78, 0x00000000}, 
                                {0x18, 0x31551212},{0x40, 0x00000000},{0x7C, 0xFFFFFFFF}, 
                                {0x1C, 0x0000202F},{0x48, 0x000000FF},{0xA0, 0x87878787}, 
                                {0x20, 0x00006F00},{0x4C, 0x00000000},{0xA4, 0x87878787}, 
    ...
    unsigned int DDR_arg[][2] ={{0x00, 0x09039D02},{0x2C, 0x00000000},{0x68, 0x00000000}, 
                                {0x08, 0x00020A63},{0x30, 0x00000000},{0x6C, 0x00000022}, 
                                {0x0C, 0x00000000},{0x34, 0x06060606},{0x70, 0x00000003}, 
                                {0x10, 0x00001212},{0x38, 0x06060606},{0x74, 0x00000022}, 
                                {0x14, 0x15090B08},{0x3C, 0x00620011},{0x78, 0x00000033}, 
                                {0x18, 0x31550212},{0x40, 0x00000000},{0x7C, 0xFFFFFFFF}, 
                                {0x1C, 0x0000202F},{0x48, 0x000000FF},{0xA0, 0x87878787}, 
