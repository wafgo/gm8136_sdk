...
/*
 * GM8139 PMU registers for RTC
 */
static pmuReg_t rtc_pmu_reg_8139[] = {
    /*
     * IP Main Clock Select Setting Register [offset=0x28]
     * ----------------------------------------------------
     * [0] RTC_CLK ==> 0: External OSC(32.768MHz) 1: Internal PLL3(6MHz)
     */
    {
     .reg_off   = 0x28,
...
static pmuRegInfo_t rtc_pmu_reg_info_8139 = {
    "RTC_8139",
    ARRAY_SIZE(rtc_pmu_reg_8139),
    ATTR_TYPE_NONE,
    &rtc_pmu_reg_8139[0]
};
...
int rtc_plat_pmu_init(void)
{
    ...
    fd = ftpmu010_register_reg(&rtc_pmu_reg_info_8139);
    if(fd < 0) {
