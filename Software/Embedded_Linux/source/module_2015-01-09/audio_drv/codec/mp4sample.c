...
**
** $Id: mp4sample.c,v 1.1 2013/09/04 06:26:55 easonli Exp $
**/
                                     ...
                                     int *chunk_sample, int *chunk)
{
    int total_entries = 0;
    int chunk2entry;
    int chunk1, chunk2, chunk1samples, range_samples, total = 0;
...
{
    int chunk, chunk_sample, chunk_offset1, chunk_offset2;
