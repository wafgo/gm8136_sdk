...
int test_working_thread_host_pack_tx0(void *private)
{
    ...
    switch(idx) {
      case 0:
        cpu_comm_pack_open(CHAN_PCI0_0_USR0, "Sender0");
        snd_msg.target = CHAN_PCI0_0_USR0;
        break;
      case 1:
        cpu_comm_pack_open(CHAN_PCI0_0_USR1, "Sender1");
        snd_msg.target = CHAN_PCI0_0_USR1;
        break;
      case 2:
        cpu_comm_pack_open(CHAN_PCI0_0_USR2, "Sender2");
        snd_msg.target = CHAN_PCI0_0_USR2;
        break;
      default:
        panic("error! \n");
        break;
    ...
    printk("PCI Master testing with TEST_SIZE = %d \n", (u32)TEST_SIZE);
...
int test_working_thread_host_tx(void *private)
{
    ...
    cpu_comm_open(CHAN_PCI0_0_USR0, "Master");
