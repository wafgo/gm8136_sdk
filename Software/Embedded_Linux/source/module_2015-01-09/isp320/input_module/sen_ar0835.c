...
static sensor_reg_t sensor_init_regs_6M[] = {      
    //[27M:6M 3264x1836 30fps op= 486Mbps]
    //486Mbps/lane
    //XMCLK=27000000
    {0x301A, 0x0218}, 	// RESET_REGISTER
    {DELAY_CODE, 300},
    ...
    {0x3008, 0x0CC7}, 	// X_ADDR_END_
    {0x3040, 0x4041}, 	// READ_MODE
    {0x300C, 5720},  	// LINE_LENGTH_PCK_
    {0x300A, 1888},     // FRAME_LENGTH_LINE_
    {0x3012, 1888},     // COARSE_INTEGRATION_TIME_
    {0x0400, 0x0000}, 	// SCALING_MODE
    {0x0402, 0x0000}, 	// SPATIAL_SAMPLING
    {0x0404, 0x0010}, 	// SCALE_M
    {0x306E, 0x9080}, 	// DATA_PATH_SELECT
    ...
    {0x3120, 0x0031}, 	// GAIN_DITHER_CONTROL
    {0x301A, 0x001C}, 	// RESET_REGISTER
    //STATE = Master Clock, 324000000	
};
#define NUM_OF_INIT_REGS_6M (sizeof(sensor_init_regs_6M) / sizeof(sensor_reg_t))

static sensor_reg_t sensor_init_regs_5M[] = {      
    //[27M:5M 2592x1944 from 3264x2448 xy:16/20]
    //2611x1958
    //675Mbps/lane
    //XMCLK=27000000
    {0x301A, 0x0218}, 	// RESET_REGISTER
...
static void adjust_vblk(int fps)
{
    ...
    else if (g_psensor->img_win.width <= 3264 && g_psensor->img_win.height <= 1836){
            frame_h = 1888;
        max_fps =30;
    }
    else{
...
static int set_size(u32 width, u32 height)
{
    ...
    if (width <= 1920 && height <= 1080){
        ...
        pInitTable=sensor_init_regs_6M;
        InitTable_Num=NUM_OF_INIT_REGS_6M;
    }
    else{
