 ...
 *
 * $Revision: 1.22 $
 * $Date: 2014/12/12 08:13:15 $
 *
 * ChangeLog:
 *  $Log: sen_imx136.c,v $
 *  Revision 1.22  2014/12/12 08:13:15  allenhsu
 *  *** empty log message ***
 *
 *  Revision 1.21  2014/11/10 01:16:24  jtwang
 *  *** empty log message ***
 *
 *  Revision 1.20  2014/07/25 08:38:32  ricktsao
 *  no message
 *
 *  Revision 1.19  2014/06/25 02:12:43  jtwang
 *  add spi register interface
 *
 *  Revision 1.18  2014/06/04 07:49:51  allenhsu
 *  Remove print message
 *
 *  Revision 1.17  2014/05/29 06:30:09  jtwang
 *  fix wdr mode green color issue
 *
 *  Revision 1.16  2014/05/27 09:32:12  jtwang
 *  fix wdr mode green color issue
 *
 *  Revision 1.15  2014/05/02 03:31:32  jtwang
 *  set_size bug fixed
 *
 *  Revision 1.14  2014/01/15 09:05:29  jtwang
 *  update wdr setting for 60fps
 *
 *  Revision 1.13  2014/01/07 05:52:53  jtwang
 *  1. fixed flicker issue
 *  2. add 1920x1200 resolution
 *  3. increase accuracy of exposure time calculation
 *
 *  Revision 1.12  2013/12/12 05:06:50  allenhsu
 *  Remove max_gain limination in WDR mode
 *
 *  Revision 1.11  2013/12/10 09:18:33  jtwang
 *  *** empty log message ***
 *
 *  Revision 1.10  2013/12/10 06:51:35  allenhsu
 *  remove min_exp limination
 *
 *  Revision 1.9  2013/11/28 09:05:54  jtwang
 *  remove warning
 *
 *  Revision 1.8  2013/11/28 07:27:22  jtwang
 *  bug fixed for wdr mode
 *
 *  Revision 1.7  2013/11/27 06:09:59  jtwang
 *  add wdr mode
 *
 *  Revision 1.6  2013/11/25 02:21:13  jtwang
 *  fixed wrong setting for 30 fps
 *
 *  Revision 1.5  2013/11/21 08:42:31  jtwang
 *  *** empty log message ***
 *
 *  Revision 1.4  2013/11/21 05:39:04  allenhsu
 *  *** empty log message ***
 *
 *  Revision 1.3  2013/11/20 02:13:59  jtwang
