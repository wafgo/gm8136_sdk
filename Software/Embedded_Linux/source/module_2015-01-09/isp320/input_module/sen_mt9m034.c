 ...
 *
 * $Revision: 1.19 $
 * $Date: 2014/08/14 08:43:49 $
 *
 * ChangeLog:
 *  $Log: sen_mt9m034.c,v $
 *  Revision 1.19  2014/08/14 08:43:49  allenhsu
 *  Fix mirror flip bayer pattern false error
 *
 *  Revision 1.18  2014/07/25 08:38:32  ricktsao
 *  no message
 *
 *  Revision 1.17  2014/07/08 03:18:24  allenhsu
 *  Fix 1280x960 become 45 fps bug
 *
 *  Revision 1.16  2014/06/16 07:37:55  jason_ha
 *  Add 960P@45fps
 *
 *  Revision 1.15  2014/05/20 07:08:17  ricktsao
 *  no message
 *
 *  Revision 1.14  2014/05/20 05:31:37  ricktsao
 *  support AR0130
 *
 *  Revision 1.13  2014/02/17 09:26:26  allenhsu
 *  Change max gain
 *
 *  Revision 1.12  2013/12/17 02:00:54  allenhsu
 *  add [wdr] module parameter
 *
 *  Revision 1.11  2013/11/25 05:00:00  allenhsu
 *  *** empty log message ***
 *
 *  Revision 1.10  2013/11/13 06:39:06  ricktsao
 *  no message
 *
 *  Revision 1.9  2013/11/12 06:04:38  allenhsu
 *  *** empty log message ***
 *
 *  Revision 1.8  2013/11/07 12:22:53  ricktsao
 *  no message
 *
 *  Revision 1.7  2013/11/04 03:49:43  allenhsu
 *  *** empty log message ***
 *
 *  Revision 1.6  2013/10/24 03:32:27  allenhsu
 *  *** empty log message ***
 *
 *  Revision 1.5  2013/10/23 10:31:04  ricktsao
 ...
 *
 *  Revision 1.3  2013/10/23 05:42:32  allenhsu
 *  Remove #define FPGA
 *
 ...
 *  no message
 *
 *  Revision 1.26  2013/09/11 08:58:14  allenhsu
 *  *** empty log message ***
 *
 *  Revision 1.25  2013/09/04 09:23:03  allenhsu
 *  Suppress SNR loss
 *
 *  Revision 1.24  2013/07/18 05:14:29  allenhsu
 *  *** empty log message ***
 *
 *  Revision 1.23  2013/07/18 02:52:26  allenhsu
 *  *** empty log message ***
 *
 *  Revision 1.22  2013/06/06 06:59:03  allenhsu
 *  *** empty log message ***
 *
 *  Revision 1.21  2013/05/21 09:56:07  ricktsao
 *  no message
 *
 *  Revision 1.20  2013/05/07 01:24:35  allenhsu
 *  Add binning mode support
 *
 *  Revision 1.19  2013/03/21 05:04:15  allenhsu
 *  *** empty log message ***
 *
 *  Revision 1.16  2013/01/21 03:17:53  allenhsu
 *  update DRC code for new FPGA
 *
 *  Revision 1.15  2013/01/04 07:01:36  allenhsu
 *  *** empty log message ***
 *
 *  Revision 1.14  2012/11/21 06:28:38  allenhsu
 *  add slow_shoot band to enhance AE stability
 *
 *  Revision 1.13  2012/11/20 03:21:15  allenhsu
 *  revise AE pre-gamma
 *
 *  Revision 1.12  2012/11/19 13:00:27  ricktsao
 *  no message
 *
 *  Revision 1.11  2012/11/13 09:46:28  allenhsu
 *  *** empty log message ***
 *
 *  Revision 1.10  2012/11/13 09:31:53  allenhsu
 *  limit WDR min_exp, max_exp
 *
 *  Revision 1.9  2012/11/07 02:44:03  ricktsao
 *  no message
 *
 *  Revision 1.8  2012/11/01 05:45:46  allenhsu
 *  *** empty log message ***
 *
 *  Revision 1.7  2012/10/23 09:26:05  ricktsao
 *  no message
 *
 *  Revision 1.6  2012/10/17 02:06:35  allenhsu
 *  *** empty log message ***
 *
 *  Revision 1.5  2012/10/12 03:41:45  allenhsu
 *  *** empty log message ***
 *
 *  Revision 1.4  2012/10/09 05:44:33  allenhsu
 *  Add WDR/LI mode switch machine for MT9M034
 *
 *  Revision 1.3  2012/09/28 01:56:24  ricktsao
 *  no message
 *
 *  Revision 1.2  2012/09/27 06:57:17  allenhsu
 *  *** empty log message ***
 *
 *  Revision 1.1  2012/09/24 09:20:23  allenhsu
 *  First version.
 *
 */
...
static gain_set_t gain_table[] =
{
    ...
    {DCG_LO, 0 ,41 , 81   }, {DCG_LO, 0 ,44 , 88   }, {DCG_LO, 0 ,48 , 96   },
    {DCG_LO, 0 ,51 , 101  }, {DCG_LO, 0 ,54 , 108  }, {DCG_LO, 0 ,57 , 113  },
    {DCG_LO, 0 ,60 , 120  }, {DCG_LO, 1 ,32 , 128  }, {DCG_LO, 1 ,33 , 131  },
