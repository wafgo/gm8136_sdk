...
#include <mach/platform-GM8210-S/platform_io.h>
...
/* SCALER300 resource 1*/
static struct resource scaler300_1_resource[] = {
	[0] = {
		.start = SCAL_FTSCAL300_1_PA_BASE,
		.end   = SCAL_FTSCAL300_1_PA_LIMIT,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = SCAL_FTSCAL300_1_IRQ,
		.end   = SCAL_FTSCAL300_1_IRQ,
		.flags = IORESOURCE_IRQ,
	},
};

static struct platform_device scaler300_1_device = {
	.name		= "FSCALER300",
	.id		= 1,
	.num_resources	= ARRAY_SIZE(scaler300_1_resource),
	.resource	= scaler300_1_resource,
	.dev		= {
				.platform_data = 0,	//index for port info
				.dma_mask = &all_dmamask,
				.coherent_dma_mask = 0xffffffffUL,
...
static pmuReg_t	pmu_reg[] = {
    ...
    {0xb0, (0x1 << 4) | (0x1 << 26), (0x1 << 4) | (0x1 << 26), 0, (0x1 << 4) | (0x1 << 26)}, //aximclkoff
};
