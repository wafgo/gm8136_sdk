/*
 * Revision History
 * VER0.1.0 2014/03/03 Add SWOSG8210 VERSION 
 * VER0.1.1 2014/03/31 Add get canvas info and rate limit 
 * VER0.1.2 2014/04/03 Add some function for static mode , but not support
 * VER0.1.3 2014/04/18 Add some function for static mode , but not support 
 * VER0.1.4 2014/05/09 2 pixsel instead of 4 pixsel for sw 
 * VER0.1.5 2014/05/12 add static memory allocate mode
 * VER0.1.6 2014/05/13 change dcache flush function 
 */
...
#define SWOSG8210_VERSION     ((0 << 16) + (1 << 8) + 6) 
