/*
 * Revision History
 * VER0.1.0 2014/03/03 Add SWOSG8287 VERSION 
 * VER0.1.1 2014/03/27 support remiander command fire when last item was fail
 * VER0.1.2 2014/03/28 add more debug message
 * VER0.1.3 2014/03/31 add more debug message and rate limit
 * VER0.1.4 2014/04/03 support static memory pool for DH
 * VER0.1.5 2014/04/16 enlarge static canvas pool number to 68 , and avoid 
 * error return when this static pool memory length is zero. 
 * VER0.1.6 2014/04/18 add swosg_eng_canvas_get_static_pool function.
 * VER0.1.7 2014/05/12 modify static mem pool interface 
 * 
 */
...
#define SWOSG8287_VERSION   ((0 << 16) + (1 << 8) + 7) 
