...
LIBS-$(CONFIG_SLI10121) += common/sli10121/sli10121.o
LIBS-$(CONFIG_CAT6611) += common/cat6611/cat6611.o
...
## GM Systems
#########################################################################
gm8126_config:		unconfig
	@mkdir -p $(obj)include $(obj)board/gm/gm8126
	@mkdir -p $(obj)board/gm/gm8126
	@$(MKCONFIG) -n $@ gm8126 arm arm926ejs gm8126 gm
	
gm8210_config:		unconfig
	@mkdir -p $(obj)include $(obj)board/gm/gm8210
	@mkdir -p $(obj)board/gm/gm8210
	@$(MKCONFIG) -n $@ gm8210 arm arm926ejs gm8210 gm

gm8139_config:		unconfig
	@mkdir -p $(obj)include $(obj)board/gm/gm8139
	@mkdir -p $(obj)board/gm/gm8139
	@$(MKCONFIG) -n $@ gm8139 arm arm926ejs gm8139 gm

gm8136_config:		unconfig
	@mkdir -p $(obj)include $(obj)board/gm/gm8136
	@mkdir -p $(obj)board/gm/gm8136
	@$(MKCONFIG) -n $@ gm8136 arm arm926ejs gm8136 gm

gm8287_config:		unconfig
	@mkdir -p $(obj)include $(obj)board/gm/gm8287
	@mkdir -p $(obj)board/gm/gm8287
	@$(MKCONFIG) -n $@ gm8287 arm arm926ejs gm8287 gm
#########################################################################
