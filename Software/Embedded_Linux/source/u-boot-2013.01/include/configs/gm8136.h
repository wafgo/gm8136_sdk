 ...
 * Justin Shih <wdshih@faraday-tech.com>
 *
 * Configuation settings for the GM EVB board.
 *
...
#include <asm/arch-gm8136/gm8136.h>
#include <asm/arch-gm8136/ahbdma.h>
#include <asm/arch-gm8136/nandc_flash.h>
#include <asm/arch-gm8136/spi020.h>
...
#define CONFIG_PLATFORM_GM8136          1
/*
...
/* gm8136.c will use it */
#define CONFIG_EXTRA_ENV_SETTINGS					 \
	"lm=sf read 0x02000000 z\0" \
	"cmd1=mem=64M gmmem=30M console=ttyS0,115200 user_debug=31 init=/squashfs_init root=/dev/mtdblock2 rootfstype=squashfs\0" \
	"cmd2=mem=128M gmmem=90M console=ttyS0,115200 user_debug=31 init=/squashfs_init root=/dev/mtdblock2 rootfstype=squashfs\0" \
	"cmd3=mem=256M gmmem=190M console=ttyS0,115200 user_debug=31 init=/squashfs_init root=/dev/mtdblock2 rootfstype=squashfs\0" \
	"cmd4=mem=512M gmmem=432M console=ttyS0,115200 user_debug=31 init=/squashfs_init root=/dev/mtdblock2 rootfstype=squashfs\0"
...
#define CONFIG_VIDEO_FB_BASE    0x3000000	/* frame buffer address */
#define CONFIG_CAT6611
#endif
...
#define GPLAT_8136_ID 	    0x81360000
...
#define AU_ENABLE "no"  /* execute firmware auto update during system start, "yes":enable, "no":disable */

#define AU_IMG_FILE_AIO "flash.img" /* store the content of whole flash */

#ifdef CONFIG_SPI_NAND_GM
#define AU_IMG_FILE_0   "u-boot_spi_nand.bin"
#endif
#ifdef CONFIG_CMD_SPI
